...
--         command = 'node',
--         args = {
--           -- vim.fn.expand('~/AppData/Local/nvim-data/mason/packages/php-debug-adapter/php-debug-adapter.cmd')
--           vim.fn.expand('C:\\Users\\dannick.bedard\\AppData\\Local\\nvim-data\\mason\\packages\\php-debug-adapter\\extension\\out\\phpDebug.js')
--         }
--       }
